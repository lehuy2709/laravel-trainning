...
<head>
    ...
    <link href="{{ asset('dist/client/css/styles.css') }}" rel="stylesheet" />
</head>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        ...
                        @endif
                    @else
                        <a id="navbarDropdown" class="nav-link" href="{{Route('faculties.index')}}">
                            {{ __('Faculties') }}
                        </a>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="card text-white bg-secondary my-5 py-4 text-center">
            <div class="card-body">
                <p class="text-white m-0">@yield('title')</p>
            </div>
        </div>
        <!-- Content Row-->
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('dist/client/js/scripts.js') }}"></script>
</body>
